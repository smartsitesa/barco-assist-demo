window.SmartSiteBotConfig = {
  ...
  title: 'Barco Assist',
  subtitle: 'Facilities support and maintenance routing',
  botTitle: 'Barco Assist Support',
  botSubtitle: 'Maintenance and facilities assistant',
  whatsappNumber: '',
  ...
  introMessage: 'Hello 👋 I can help with Barco Assist maintenance, hygiene, COC services, technology/reporting and facilities support questions. Choose an option or type your question.',
  quickReplies: [
    'Maintenance support',
    'COC services',
    'Hygiene support',
  ...
  parameters: [
    ...
    { keywords: ['technology', 'reporting', 'dashboard', 'real-time'], reply: 'Barco Assist is positioned around real-time reporting, predictive maintenance thinking and better operational visibility.' },
    { keywords: ['commercial', 'retail', 'student accommodation', 'body corporate', 'landlord'], reply: 'Barco Assist is positioned for commercial sites, retail portfolios, student accommodation, private landlords and body corporates.' },
  ...
  siteAnswers: [
    ...
    { keywords: ['hygiene'], reply: 'The Hygiene section presents Barco Assist as a cleaner, presentation-focused support layer for managed environments.', links: [{ label: 'Open Hygiene', href: 'index.html#hygiene' }] },
    { keywords: ['technology', 'reporting'], reply: 'The Technology section explains Barco Assist around real-time reporting, predictive maintenance thinking and better operational visibility.', links: [{ label: 'Open Technology', href: 'index.html#technology' }] },
